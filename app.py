    ...
    def run(self):
        ...
        with tab1:
            ...
            if st.session_state.processing_active:
                ...
                st.info("⏳ Обработка выполняется в фоновом режиме...")
        ...
        with tab4:
            ...
            **Полнофункциональная система для анализа научных статей с поддержкой:**
            ...
            ✅ **Настройка параллельности** (1-10 потоков, batch 50)  
